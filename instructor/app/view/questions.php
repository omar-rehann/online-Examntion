...
<?php } ?>
                    ...
                    <div class="row form-group">
                      <div class="col col-md-3"></div>
                      <div class="col-12 col-md-9 text-right">
                        <button type="button" id="addMatch" class="btn btn-info btn-lg btn-block"><i class="fa fa-plus"></i> Add More Answers</button>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="row form-group">
                          <ul id="MatchingAnswers">
                            ...
                            <li class="list-group-item" id="matchListItem<?php echo $i ?>">
															...
															<div class="row">
																<div class="col-4">
																	<input type="text" class="form-control matchInp" placeholder="Clue <?php echo $i ?>" name="match[]" value="<?php echo $answer->answer; ?>">
																</div>
																	<i class="fa fa-arrow-right mt-2" aria-hidden="true"></i>
																<div class="col-4">
																	<input type="text" class="form-control matchAnswerInp" placeholder="Match <?php echo $i ?>" name="matchAnswer[]" value="<?php echo $answer->matchAnswer; ?>">
																</div>
																<div class="col-2">
																	<input type="number" class="form-control" placeholder="Points" value="<?php echo $answer->points; ?>" name="matchPoints[]">
																</div>
                    ...
                    <?php
                        ...
                        <div class="card">
                          ...
                          <div class="card-footer">
                            ...
                            <?php } ?>
                            <button type="button" onclick="window.location.href='?questions=edit&id=<?php echo $_GET['id'] ?>'" class="btn btn-primary m-1" style="float:right"><i class="fa fa-magic"></i>&nbsp; Edit This Question</button>
                          </div>
                        </div>
                      </div>
