...
(function($) {
    ...
    $('.showLink').click(function(e) {
        ...
        Swal.fire({
            ...
            html: '<div class="input-group mb-3"><div class="input-group-prepend"><span class="input-group-text">Link</span></div><input type="text" id="lnk" class="form-control" value="' + link + '" readonly><div class="input-group-append"><button class="btn btn-outline-secondary" type="button" data-clipboard-target="#lnk">Copy Link</button></div></div>' +
