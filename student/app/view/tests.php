...
<div class="card" style="width: 80%;border-radius: 0;margin: 0 auto;float: none;margin-bottom: 180px;margin-top: 20px;" id="questionsContainer"></div>

<div class="container bg-light boxshadow">
    <div class="row">
        <div class="col">
            <a type="button" class="btn btn-outline-primary btn-lg" style="float: left;" id="PreviousQuestion">
                <i class="fa fa-chevron-left" aria-hidden="true"></i> Previous Question
            </a>
        </div>
        ...
        <div class="col">
            <a type="button" class="btn btn-outline-primary btn-lg" style="float: right;" id="NextQuestion">
                Next Question <i class="fa fa-chevron-right" aria-hidden="true"></i>
            </a>
        </div>
    </div>
</div>
                ...
                <div class="alert-box alert-default">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <div> <i class="fa fa-user"></i> Your Name 
                                <span class="font-weight-bold pull-right"><?php echo $_SESSION['student']->name ?></span>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div> <i class="fa fa-address-book"></i> Your ID 
                                <span class="badge badge-secondary pull-right"><?php echo $_SESSION['student']->id ?></span>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div> <i class="fa fa-clock-o"></i> Test Starts 
                                <span class="badge badge-success pull-right"><?php echo date("Y-m-d h:i a", strtotime($myTest->startTime)); ?></span>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div> <i class="fa fa-clock-o"></i> Test Ends 
                        ...
                        <li class="list-group-item">
                            <div> <i class="fa fa-percent"></i> Pass Percent: 
                                <span class="badge badge-warning pull-right"><?php echo $myTest->passPercent ?>%</span>
                            </div>
                        </li>
                        <li class="list-group-item">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" href="?tests&id=<?php echo $myTest->id ?>&start" class="btn btn-outline-primary mb-1">
                                    <i class="fa fa-plus"></i> Start Test
                                </a>
                            </td>
                        </tr>
                        <?php } ?>
